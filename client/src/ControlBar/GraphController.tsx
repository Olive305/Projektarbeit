...
class GraphController {
  ...
  public setFitness: any;
  public setPrecision: any;
  public setGeneralization: any;
  public setSimplicity: any;
  ...
  public constructor(gridSize: number, showPreview?: boolean, notAddStartingNode?: boolean) {
    ...
    this.setFitness = (_: number) => {};
    this.setSimplicity = (_: number) => {};
  ...
  public setMetricsChange(setFitness: Dispatch<SetStateAction<number>>, setPrecision: Dispatch<SetStateAction<number>>, setSimplicity: Dispatch<SetStateAction<number>>, setGeneralization: Dispatch<SetStateAction<number>>) {
    ...
    this.setSimplicity = setSimplicity;
    this.setGeneralization = setGeneralization;
  ...
  public calculateColor = (id: string) => {
    const colorList = [
        ...
        'cyan', 'magenta', 'lime', 'olive', 'teal', 'navy',
        'indigo', 'violet', 'gold', 'beige', 'chocolate'
    ];
  ...
  public deserializePredictNodes(data: string) {
    ...
    this.setFitness(metricsData.fitness);
    this.setSimplicity(metricsData.simplicity);
    this.setPrecision(metricsData.precision);
    this.setGeneralization(metricsData.generalization);
